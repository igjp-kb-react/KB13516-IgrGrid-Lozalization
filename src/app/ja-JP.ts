export const JPResourceStrings = {
  ...
  igx_grid_advanced_filter_initial_text:
    '"And" あるいは "Or" にリンクされた条件のグループの作成から始めます。',
  ...
  igx_grid_groupByArea_select_message:
    "フィールド名 {0}、値 {1} のグループ内のすべての行を選択します。",
  igx_grid_groupByArea_deselect_message:
    "フィールド名 {0}、値 {1} のグループ内のすべての行を選択解除します。",
  ...
  igx_grid_min_length_validation_error:
    "入力の長さは少なくとも {0} 文字である必要があります",
  igx_grid_max_length_validation_error:
    "入力の長さは {0} 文字以下である必要があります",
