...
import "./app.css";
import { JPResourceStrings } from "./ja-JP";

const sampleData = [
  { id: 1, name: "John", country: "USA", age: 37 },
  { id: 2, name: "Alice", country: "India", age: 32 },
  { id: 3, name: "Bob", country: "Korea", age: 25 },
  { id: 4, name: "Taro", country: "Japan", age: 20 },
  { id: 5, name: "Chen", country: "China", age: 45 },
  ...
  { id: 14, name: "Hanako", country: "Japan", age: 20 },
  { id: 15, name: "Lee", country: "China", age: 45 },
...
export const App = () => {
  return (
    <div style={{ maxWidth: "600px", margin: "24px auto" }}>
      ...
      >
        <IgrColumn field="id" header="ID" headerGroupClasses="VerticalHeader" />
